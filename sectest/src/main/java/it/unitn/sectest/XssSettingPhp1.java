...
public class XssSettingPhp1 extends Base{
	...
	@Test
	public void XssSettingPhp1Test() {
		...
		settingsPage.changeUsername("admin \"/> <h1>test</h1>");
		settingsPage.moveToSetting();
		
		try {
			String xssvar = driver.findElement(By.xpath("/html[1]/body[1]/div[1]/div[1]/div[1]/div[1]/div[2]/form[1]/fieldset[1]/div[2]/div[1]/h1[1]")).getAttribute("innerHTML");
