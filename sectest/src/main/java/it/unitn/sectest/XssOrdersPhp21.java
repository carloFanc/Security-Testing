...
public class XssOrdersPhp21 extends Base{
	...
	@Test
	public void XssOrdersPhp21Test() {
		...
		addOrdersPage.add("01/01/2020", "\"> <h1>test</h1>", "tizio", "prova", "0", "0", "Cash", "Full Payment", "In Gujarat");
		manageOrdersPage = addOrdersPage.moveToManageOrders();
		manageOrdersPage.edit();
		
		try {
			String injectedvar = driver.findElement(By.xpath("/html[1]/body[1]/div[1]/div[2]/div[2]/form[1]/div[2]/div[1]/h1[1]")).getAttribute("innerHTML");
