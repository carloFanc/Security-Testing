...
public class XssProductPhp3 extends Base{
	...
	@Test
	public void XssProductPhp3Test() {
		...
		try {
			...
			productPage.add("prova", "10", "10", "brand", "category</option></select><h1>test</h1>", "Available");
		}
		productPage.openEdit();
		try {
			String var = driver.findElement(By.xpath("/html[1]/body[1]/div[1]/div[3]/div[1]/div[1]/div[2]/div[2]/div[1]/div[2]/form[1]/div[6]/div[1]/h1[1]")).getAttribute("innerHTML");
